...
session_start();
//in_session változó tárolja, hogy van-e már megkezdett session
$in_session = false;
...
<body>
    <div class="container text-white">
        <!--Címsor-->
        <div class="row align-items-center" id="cimsor">
            <div class="col text-center">
                <h1 id="cim" class="font-weight-bold">Kvíz</h1>
            </div>
        </div>
        <!--Tartalom -->
                ...
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <input type="text" id="nevField" autocomplete="off" placeholder="Max 10 karakter" class="border border-dark bg-primary rounded text-white">
                        </div>
                    </div>
